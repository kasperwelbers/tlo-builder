...
export interface Course { id: number; projectId: string; name: string; description: string; color: string; coordinator: string | null; start: string | null; end: string | null }
