...
export type InsertTrajectory = typeof trajectories.$inferInsert;

export type Lto = typeof ltos.$inferSelect;
export type InsertLto = typeof ltos.$inferInsert;

export type Course = typeof courses.$inferSelect;
export type InsertCourse = typeof courses.$inferInsert;

export type Ilo = typeof ilos.$inferSelect;
export type InsertIlo = typeof ilos.$inferInsert;

export type Mapping = typeof mappings.$inferSelect;
export type InsertMapping = typeof mappings.$inferInsert;

export type TrajectoryWithLtos = Trajectory & { ltos: Lto[] };
export type CourseWithIlos = Course & { ilos: Ilo[] };
